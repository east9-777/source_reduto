...
# instance fields
.field private final callbackThreadSupplier:La/bg3;
...
.field private final queueingThreadSupplier:La/bg3;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "La/bg3<",
            "Landroid/os/HandlerThread;",
...
.method public constructor <init>(I)V
    ...
    invoke-direct {v0, p1, v1}, La/gb;-><init>(II)V

    new-instance v1, La/gb;

    const/4 v2, 0x1

    invoke-direct {v1, p1, v2}, La/gb;-><init>(II)V

    invoke-direct {p0, v0, v1}, Landroidx/media3/exoplayer/mediacodec/AsynchronousMediaCodecAdapter$Factory;-><init>(La/bg3;La/bg3;)V

    return-void
.end method

.method public constructor <init>(La/bg3;La/bg3;)V
    .locals 0
    ...
    .line 3
    iput-object p1, p0, Landroidx/media3/exoplayer/mediacodec/AsynchronousMediaCodecAdapter$Factory;->callbackThreadSupplier:La/bg3;

    .line 4
    iput-object p2, p0, Landroidx/media3/exoplayer/mediacodec/AsynchronousMediaCodecAdapter$Factory;->queueingThreadSupplier:La/bg3;
...
.method public createAdapter(Landroidx/media3/exoplayer/mediacodec/MediaCodecAdapter$Configuration;)Landroidx/media3/exoplayer/mediacodec/AsynchronousMediaCodecAdapter;
    ...
    iget-object v4, p0, Landroidx/media3/exoplayer/mediacodec/AsynchronousMediaCodecAdapter$Factory;->queueingThreadSupplier:La/bg3;
    ...
    iget-object v5, p0, Landroidx/media3/exoplayer/mediacodec/AsynchronousMediaCodecAdapter$Factory;->callbackThreadSupplier:La/bg3;
