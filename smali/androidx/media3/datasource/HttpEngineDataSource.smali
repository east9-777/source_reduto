...
.field private contentTypePredicate:La/jn2;
...
# direct methods
.method public constructor <init>(Landroid/net/http/HttpEngine;Ljava/util/concurrent/Executor;IIIZZLjava/lang/String;Landroidx/media3/datasource/HttpDataSource$RequestProperties;La/jn2;Z)V
    .locals 1
    ...
    .line 9
    invoke-static {p1}, La/rx0;->g(Ljava/lang/Object;)Landroid/net/http/HttpEngine;
    ...
    .line 36
    .line 37
    iput-object p10, p0, Landroidx/media3/datasource/HttpEngineDataSource;->contentTypePredicate:La/jn2;
...
.method private buildRequestBuilder(Landroidx/media3/datasource/DataSpec;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;
    ...
    .line 10
    .line 11
    invoke-static {v0, v1, v2, p2}, La/rx0;->i(Landroid/net/http/HttpEngine;Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;
    ...
    .line 16
    .line 17
    invoke-static {p2, v0}, La/rx0;->k(Landroid/net/http/UrlRequest$Builder;I)Landroid/net/http/UrlRequest$Builder;
    ...
    .line 21
    invoke-static {p2}, La/rx0;->j(Landroid/net/http/UrlRequest$Builder;)Landroid/net/http/UrlRequest$Builder;
    ...
    .line 86
    .line 87
    invoke-static {p2, v3, v2}, La/rx0;->t(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 124
    .line 125
    invoke-static {p2, v0}, La/rx0;->C(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;)V
    ...
    .line 131
    .line 132
    invoke-static {p2, v0}, La/rx0;->s(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;)V
    ...
    .line 139
    invoke-static {p2, v0}, La/rx0;->A(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;)V
    ...
    .line 154
    .line 155
    invoke-static {p2, v0, p1}, La/rx0;->r(Landroid/net/http/UrlRequest$Builder;Landroid/net/http/UploadDataProvider;Ljava/util/concurrent/Executor;)V
...
.method private buildRequestWrapper(Landroidx/media3/datasource/DataSpec;)Landroidx/media3/datasource/HttpEngineDataSource$UrlRequestWrapper;
    ...
    .line 13
    invoke-static {p1}, La/rx0;->l(Landroid/net/http/UrlRequest$Builder;)Landroid/net/http/UrlRequest;
...
.method private static isCompressed(Landroid/net/http/UrlResponseInfo;)Z
    ...
    .line 1
    invoke-static {p0}, La/rx0;->f(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;
    ...
    .line 5
    invoke-static {p0}, La/rx0;->p(Landroid/net/http/HeaderBlock;)Ljava/util/List;
...
.method public getResponseCode()I
    ...
    .line 4
    .line 5
    invoke-static {v0}, La/rx0;->c(Landroid/net/http/UrlResponseInfo;)I
...
.method public getResponseHeaders()Ljava/util/Map;
    ...
    .line 10
    :cond_0
    invoke-static {v0}, La/rx0;->f(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;
    ...
    .line 14
    invoke-static {v0}, La/rx0;->q(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
...
.method public getUri()Landroid/net/Uri;
    ...
    .line 7
    :cond_0
    invoke-static {v0}, La/rx0;->z(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
...
.method public open(Landroidx/media3/datasource/DataSpec;)J
    ...
    .line 50
    .line 51
    invoke-static {v2}, La/yj4;->w(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 89
    invoke-static {v0}, La/rx0;->m(Ljava/lang/Object;)Landroid/net/http/UrlResponseInfo;
    ...
    .line 101
    invoke-static {v4}, La/rx0;->q(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
    ...
    .line 120
    :cond_2
    iget-object v12, v1, Landroidx/media3/datasource/HttpEngineDataSource;->contentTypePredicate:La/jn2;
    ...
    .line 131
    .line 132
    invoke-interface {v12, v13}, La/jn2;->apply(Ljava/lang/Object;)Z
    ...
    .line 261
    .line 262
    invoke-static {v0}, La/rx0;->o(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
...
.method public read([BII)I
    ...
    .line 1
    iget-boolean v2, p0, Landroidx/media3/datasource/HttpEngineDataSource;->opened:Z
    ...
    .line 5
    iget-object v7, p0, Landroidx/media3/datasource/HttpEngineDataSource;->operation:Landroidx/media3/common/util/ConditionVariable;
    ...
    .line 7
    iget-object v7, p0, Landroidx/media3/datasource/HttpEngineDataSource;->currentDataSpec:Landroidx/media3/datasource/DataSpec;
    ...
    invoke-direct {p0, v3, v7}, Landroidx/media3/datasource/HttpEngineDataSource;->readInternal(Ljava/nio/ByteBuffer;Landroidx/media3/datasource/DataSpec;)V

    .line 8
    iget-boolean v7, p0, Landroidx/media3/datasource/HttpEngineDataSource;->finished:Z

    if-eqz v7, :cond_2

    .line 9
    iput-wide v5, p0, Landroidx/media3/datasource/HttpEngineDataSource;->bytesRemaining:J
