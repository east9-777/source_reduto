...
.method public declared-synchronized onFailed(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Landroid/net/http/HttpException;)V
    ...
    :cond_0
    :try_start_1
    invoke-static {p3}, La/rx0;->x(Ljava/lang/Object;)Z
    ...
    .line 13
    .line 14
    invoke-static {p3}, La/rx0;->h(Ljava/lang/Object;)Landroid/net/http/NetworkException;
    ...
    .line 18
    invoke-static {p1}, La/rx0;->b(Landroid/net/http/NetworkException;)I
...
.method public declared-synchronized onRedirectReceived(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Ljava/lang/String;)V
    ...
    .line 20
    .line 21
    invoke-static {p2}, La/rx0;->c(Landroid/net/http/UrlResponseInfo;)I
    ...
    .line 41
    .line 42
    invoke-static {p2}, La/rx0;->o(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
    ...
    .line 46
    invoke-static {p2}, La/rx0;->f(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;
    ...
    .line 50
    invoke-static {p2}, La/rx0;->q(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
    ...
    .line 120
    .line 121
    invoke-static {p1}, La/rx0;->u(Landroid/net/http/UrlRequest;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    :cond_6
    :try_start_4
    invoke-static {p1}, La/rx0;->B(Landroid/net/http/UrlRequest;)V
