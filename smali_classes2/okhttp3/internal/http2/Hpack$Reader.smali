...
# direct methods
.method public constructor <init>(La/tb3;I)V
    .locals 7
    .param p1    # La/tb3;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public constructor <init>(La/tb3;II)V
    .locals 1
    .param p1    # La/tb3;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:La/go;
...
.method public synthetic constructor <init>(La/tb3;IIILa/g90;)V
    .locals 0
    ...
    .line 9
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(La/tb3;II)V
...
.method private final getName(I)La/tp;
    .locals 3
    ...
    .line 14
    .line 15
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:La/tp;
...
.method private final readByte()I
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:La/go;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)La/tp;
    ...
    .line 5
    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()La/tp;
    ...
    .line 10
    .line 11
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(La/tp;La/tp;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    .line 7
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(La/tp;)La/tp;
    ...
    .line 16
    .line 17
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(La/tp;La/tp;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    .line 12
    .line 13
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(La/tp;La/tp;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    .line 18
    .line 19
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(La/tp;La/tp;)V
...
.method public final readByteString()La/tp;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 29
    .line 30
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:La/go;

    .line 31
    .line 32
    invoke-virtual {v1, v4, v2, v3, v0}, Lokhttp3/internal/http2/Huffman;->decode(La/go;JLa/fo;)V
    ...
    .line 43
    .line 44
    invoke-interface {v0, v2, v3}, La/go;->i(J)La/tp;
