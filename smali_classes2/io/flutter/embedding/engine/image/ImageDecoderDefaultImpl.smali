...
.method private synthetic lambda$decodeImage$0(Landroid/graphics/ImageDecoder;Landroid/graphics/ImageDecoder$ImageInfo;Landroid/graphics/ImageDecoder$Source;)V
    ...
    .line 5
    invoke-static {p3}, La/hi;->p(Landroid/graphics/ColorSpace$Named;)Landroid/graphics/ColorSpace;
    ...
    .line 9
    invoke-static {p1, p3}, La/a9;->t(Landroid/graphics/ImageDecoder;Landroid/graphics/ColorSpace;)V
...
.method public decodeImage(Ljava/nio/ByteBuffer;Lio/flutter/embedding/engine/image/Metadata;)Landroid/graphics/Bitmap;
    ...
    .line 1
    invoke-static {p1}, La/a9;->f(Ljava/nio/ByteBuffer;)Landroid/graphics/ImageDecoder$Source;
    ...
    .line 5
    :try_start_0
    new-instance p2, Lio/flutter/embedding/engine/image/a;

    .line 6
    .line 7
    invoke-direct {p2, p0}, Lio/flutter/embedding/engine/image/a;-><init>(Lio/flutter/embedding/engine/image/ImageDecoderDefaultImpl;)V

    .line 8
    .line 9
    .line 10
    invoke-static {p1, p2}, La/x90;->h(Landroid/graphics/ImageDecoder$Source;Lio/flutter/embedding/engine/image/a;)Landroid/graphics/Bitmap;
