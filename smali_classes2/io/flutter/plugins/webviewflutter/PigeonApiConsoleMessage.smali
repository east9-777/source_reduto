.class public abstract Lio/flutter/plugins/webviewflutter/PigeonApiConsoleMessage;
...
.method public constructor <init>(Lio/flutter/plugins/webviewflutter/AndroidWebkitLibraryPigeonProxyApiRegistrar;)V
    ...
    .line 8
    .line 9
    iput-object p1, p0, Lio/flutter/plugins/webviewflutter/PigeonApiConsoleMessage;->pigeonRegistrar:Lio/flutter/plugins/webviewflutter/AndroidWebkitLibraryPigeonProxyApiRegistrar;
...
.method public static synthetic a(La/kv0;Ljava/lang/Object;)V
    ...
    invoke-static {p0, v0, p1}, Lio/flutter/plugins/webviewflutter/PigeonApiConsoleMessage;->pigeon_newInstance$lambda$0(La/kv0;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public getPigeonRegistrar()Lio/flutter/plugins/webviewflutter/AndroidWebkitLibraryPigeonProxyApiRegistrar;
    ...
    .line 1
    iget-object v0, p0, Lio/flutter/plugins/webviewflutter/PigeonApiConsoleMessage;->pigeonRegistrar:Lio/flutter/plugins/webviewflutter/AndroidWebkitLibraryPigeonProxyApiRegistrar;
...
.method public abstract level(Landroid/webkit/ConsoleMessage;)Lio/flutter/plugins/webviewflutter/ConsoleMessageLevel;
...
.method public abstract lineNumber(Landroid/webkit/ConsoleMessage;)J
    .param p1    # Landroid/webkit/ConsoleMessage;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
...
.method public abstract message(Landroid/webkit/ConsoleMessage;)Ljava/lang/String;
    .param p1    # Landroid/webkit/ConsoleMessage;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
...
.method public final pigeon_newInstance(Landroid/webkit/ConsoleMessage;La/kv0;)V
    .locals 10
    .param p1    # Landroid/webkit/ConsoleMessage;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 10
    .line 11
    invoke-virtual {p0}, Lio/flutter/plugins/webviewflutter/PigeonApiConsoleMessage;->getPigeonRegistrar()Lio/flutter/plugins/webviewflutter/AndroidWebkitLibraryPigeonProxyApiRegistrar;
    ...
    .line 67
    invoke-virtual {p0, p1}, Lio/flutter/plugins/webviewflutter/PigeonApiConsoleMessage;->lineNumber(Landroid/webkit/ConsoleMessage;)J
    ...
    .line 71
    invoke-virtual {p0, p1}, Lio/flutter/plugins/webviewflutter/PigeonApiConsoleMessage;->message(Landroid/webkit/ConsoleMessage;)Ljava/lang/String;
    ...
    .line 75
    invoke-virtual {p0, p1}, Lio/flutter/plugins/webviewflutter/PigeonApiConsoleMessage;->level(Landroid/webkit/ConsoleMessage;)Lio/flutter/plugins/webviewflutter/ConsoleMessageLevel;
    ...
    .line 79
    invoke-virtual {p0, p1}, Lio/flutter/plugins/webviewflutter/PigeonApiConsoleMessage;->sourceId(Landroid/webkit/ConsoleMessage;)Ljava/lang/String;
    ...
    .line 87
    invoke-virtual {v6}, Lio/flutter/plugins/webviewflutter/AndroidWebkitLibraryPigeonProxyApiRegistrar;->getBinaryMessenger()Lio/flutter/plugin/common/BinaryMessenger;
    ...
    .line 102
    .line 103
    invoke-direct {v8, v6, v9, v7}, Lio/flutter/plugin/common/BasicMessageChannel;-><init>(Lio/flutter/plugin/common/BinaryMessenger;Ljava/lang/String;Lio/flutter/plugin/common/MessageCodec;)V
    ...
    .line 114
    filled-new-array {v0, v1, v4, v5, p1}, [Ljava/lang/Object;
    ...
    .line 128
    .line 129
    invoke-virtual {v8, p1, v0}, Lio/flutter/plugin/common/BasicMessageChannel;->send(Ljava/lang/Object;Lio/flutter/plugin/common/BasicMessageChannel$Reply;)V
...
.method public abstract sourceId(Landroid/webkit/ConsoleMessage;)Ljava/lang/String;
    .param p1    # Landroid/webkit/ConsoleMessage;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
