.class public final Lio/flutter/plugins/webviewflutter/PigeonApiWebSettingsCompat$Companion;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lio/flutter/plugins/webviewflutter/PigeonApiWebSettingsCompat;
.end annotation
...
.method public synthetic constructor <init>(La/g90;)V
    ...
    .line 1
    invoke-direct {p0}, Lio/flutter/plugins/webviewflutter/PigeonApiWebSettingsCompat$Companion;-><init>()V

    return-void
.end method

.method public static synthetic a(Lio/flutter/plugins/webviewflutter/PigeonApiWebSettingsCompat;Ljava/lang/Object;Lio/flutter/plugin/common/BasicMessageChannel$Reply;)V
    .locals 0

    .line 1
    invoke-static {p0, p1, p2}, Lio/flutter/plugins/webviewflutter/PigeonApiWebSettingsCompat$Companion;->setUpMessageHandlers$lambda$1$lambda$0(Lio/flutter/plugins/webviewflutter/PigeonApiWebSettingsCompat;Ljava/lang/Object;Lio/flutter/plugin/common/BasicMessageChannel$Reply;)V

    return-void
.end method

.method private static final setUpMessageHandlers$lambda$1$lambda$0(Lio/flutter/plugins/webviewflutter/PigeonApiWebSettingsCompat;Ljava/lang/Object;Lio/flutter/plugin/common/BasicMessageChannel$Reply;)V
    .locals 2
    ...
    .line 41
    :try_start_0
    invoke-virtual {p0, v0, p1}, Lio/flutter/plugins/webviewflutter/PigeonApiWebSettingsCompat;->setPaymentRequestEnabled(Landroid/webkit/WebSettings;Z)V
...
# virtual methods
.method public final setUpMessageHandlers(Lio/flutter/plugin/common/BinaryMessenger;Lio/flutter/plugins/webviewflutter/PigeonApiWebSettingsCompat;)V
    .locals 3
    .param p1    # Lio/flutter/plugin/common/BinaryMessenger;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .param p2    # Lio/flutter/plugins/webviewflutter/PigeonApiWebSettingsCompat;
    ...
    .line 7
    .line 8
    invoke-virtual {p2}, Lio/flutter/plugins/webviewflutter/PigeonApiWebSettingsCompat;->getPigeonRegistrar()Lio/flutter/plugins/webviewflutter/AndroidWebkitLibraryPigeonProxyApiRegistrar;
