.class public abstract Lio/flutter/plugins/webviewflutter/PigeonApiSslCertificate;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/flutter/plugins/webviewflutter/PigeonApiSslCertificate$Companion;
    }
.end annotation
...
# static fields
.field public static final Companion:Lio/flutter/plugins/webviewflutter/PigeonApiSslCertificate$Companion;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lio/flutter/plugins/webviewflutter/PigeonApiSslCertificate$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lio/flutter/plugins/webviewflutter/PigeonApiSslCertificate$Companion;-><init>(La/g90;)V

    sput-object v0, Lio/flutter/plugins/webviewflutter/PigeonApiSslCertificate;->Companion:Lio/flutter/plugins/webviewflutter/PigeonApiSslCertificate$Companion;
...
.method public constructor <init>(Lio/flutter/plugins/webviewflutter/AndroidWebkitLibraryPigeonProxyApiRegistrar;)V
    ...
    .line 8
    .line 9
    iput-object p1, p0, Lio/flutter/plugins/webviewflutter/PigeonApiSslCertificate;->pigeonRegistrar:Lio/flutter/plugins/webviewflutter/AndroidWebkitLibraryPigeonProxyApiRegistrar;
...
.method public static synthetic a(La/kv0;Ljava/lang/Object;)V
    ...
    .line 1
    const-string v0, "dev.flutter.pigeon.webview_flutter_android.SslCertificate.pigeon_newInstance"

    invoke-static {p0, v0, p1}, Lio/flutter/plugins/webviewflutter/PigeonApiSslCertificate;->pigeon_newInstance$lambda$0(La/kv0;Ljava/lang/String;Ljava/lang/Object;)V
...
# virtual methods
.method public abstract getIssuedBy(Landroid/net/http/SslCertificate;)Landroid/net/http/SslCertificate$DName;
...
.method public abstract getIssuedTo(Landroid/net/http/SslCertificate;)Landroid/net/http/SslCertificate$DName;
    .param p1    # Landroid/net/http/SslCertificate;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
...
.method public getPigeonRegistrar()Lio/flutter/plugins/webviewflutter/AndroidWebkitLibraryPigeonProxyApiRegistrar;
    ...
    .line 1
    iget-object v0, p0, Lio/flutter/plugins/webviewflutter/PigeonApiSslCertificate;->pigeonRegistrar:Lio/flutter/plugins/webviewflutter/AndroidWebkitLibraryPigeonProxyApiRegistrar;
...
.method public abstract getValidNotAfterMsSinceEpoch(Landroid/net/http/SslCertificate;)Ljava/lang/Long;
    .param p1    # Landroid/net/http/SslCertificate;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
...
.method public abstract getValidNotBeforeMsSinceEpoch(Landroid/net/http/SslCertificate;)Ljava/lang/Long;
    .param p1    # Landroid/net/http/SslCertificate;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
...
.method public abstract getX509Certificate(Landroid/net/http/SslCertificate;)Ljava/security/cert/X509Certificate;
    .param p1    # Landroid/net/http/SslCertificate;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
...
.method public final pigeon_newInstance(Landroid/net/http/SslCertificate;La/kv0;)V
    .locals 5
    .param p1    # Landroid/net/http/SslCertificate;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 10
    .line 11
    invoke-virtual {p0}, Lio/flutter/plugins/webviewflutter/PigeonApiSslCertificate;->getPigeonRegistrar()Lio/flutter/plugins/webviewflutter/AndroidWebkitLibraryPigeonProxyApiRegistrar;
    ...
    .line 84
    .line 85
    const-string v4, "dev.flutter.pigeon.webview_flutter_android.SslCertificate.pigeon_newInstance"
